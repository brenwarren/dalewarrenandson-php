...
<!--<![endif]-->
    <head>
      ...
      <title>Plumbing &amp; Heating services in Newtown, Powys, Mid Wales | Installing | Servicing | Repairs</title>
      <meta name="description" content="Authorised OFTEC, Gas Safe, HETAS Plumbing and Heating Services in Newtown, Powys, Mid Wales. 
      Installation, Servicing, Modifications and Repairs. Also including Fires and Burners - Wood, Gas, Oil and Coal.">
...
<div class="avoid-menubar"></div>
    ...
    <span itemscope itemtype="http://schema.org/LocalBusiness">
      ...
      <div class="container-fluid" style="padding-bottom: 0px">
        ...
        <div style="float:left"class="fb-like-box" data-href="https://www.facebook.com/pages/Dale-Warren-and-Son/209787915740437" 
data-width="200" data-height="100" data-colorscheme="light" data-show-faces="false" data-header="true" 
      ...
      <!-- START OF Services section -->
       ...
       <div style="" class="service-buttons">
              ...
              <!--   <span class="glyphicon glyphicon-fire glyphicon-lg">
                  ...
                  <a class="btn btn-lg woodburner-bg-color btn-woodburner" style="" href="wood-burner-services.php" >Wood Burners</a>
                
              <!--    <span class="glyphicon glyphicon-certificate glyphicon-lg">
                  </span>  -->
                  
                  <a class="btn btn-lg heating-bg-color btn-heating" style="" href="heating-services.php">Heating</a>
                   <!--   <span class="glyphicon glyphicon-tint glyphicon-lg">
                  </span>   -->
                  
                  <a class="btn btn-lg plumbing-bg-color btn-plumbing" style="" href="plumbing-services.php">Plumbing</a>
